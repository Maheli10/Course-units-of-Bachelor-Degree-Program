...
public class fish extends JFrame implements MouseListener{
    Graphics g;
    int x1,y1;;
    double[][] p;
    ...
    void drawObject(double[][] point){
		...
		DDA((int)p[0][0],(int)p[1][0],(int)p[0][6],(int)p[1][6]);
		DDA((int)p[0][1],(int)p[1][1],(int)p[0][6],(int)p[1][6]);
		g.setColor(Color.red);
        DDA((int)p[0][1],(int)p[1][1],(int)p[0][2],(int)p[1][2]);
        DDA((int)p[0][2],(int)p[1][2],(int)p[0][3],(int)p[1][3]);
		DDA((int)p[0][4],(int)p[1][4],(int)p[0][5],(int)p[1][5]);
		DDA((int)p[0][5],(int)p[1][5],(int)p[0][6],(int)p[1][6]);
	}
